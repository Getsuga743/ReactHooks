...
//-2 si la data es null al negarla, pasa a un valor booleano de true, y al volver a complementarla queda devuelta en false, pero ya podemos usarlo xq no es null
